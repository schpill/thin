<?php
    namespace Thin\Controller\Uri;

    use Thin\Controller\Uri;
    use Thin\Exception;
    ...
    class Http extends Uri
    {
         ...
         * @throws Exception When the URI is not valid
         */
         ...
         * @throws Exception        When the given $uri is invalid
         * @return Http
         */
        public static function fromString($uri)
        {
            ...
            $schemeHandler = new Http($scheme, $schemeSpecific);
         ...
         * @throws Exception When scheme-specific decoposition fails
         * @throws Exception When authority decomposition fails
         * @return void
         */
         ...
         *
         * @throws Exception When one or more parts of the URI are invalid
         * @return string
         */
         ...
         * @throws Exception When username validation fails
         * @return boolean
         ...
         *
         * @param  string $username The HTTP username
         * @throws Exception When $username is not a valid HTTP username
         * @return string
         */
         ...
         * @throws Exception When password validation fails
         * @return boolean
         * @link   http://www.faqs.org/rfcs/rfc2396.html
         */
         ...
         *
         * @param  string $password The HTTP password
         * @throws Exception When $password is not a valid HTTP password
         * @return string
         */
         ...
         * @throws Exception When $host is nota valid HTTP host
         * @return string
         */
         ...
         *
         * @param  string $port The HTTP port
         * @throws Exception When $port is not a valid HTTP port
         * @return string
         */
         ...
         * @throws Exception When path validation fails
         * @return boolean
         */
         ...
         *
         * @param  string $path The HTTP path
         * @throws Exception When $path is not a valid HTTP path
         * @return string
         */
         ...
         * @throws Exception When $query is not a valid query string
         * @return string              Old query string
         */
         ...
         * @throws Exception When fragment validation fails
         * @return boolean
         * @link   http://www.faqs.org/rfcs/rfc2396.html
         */
         ...
         * @throws Exception When $fragment is not a valid HTTP fragment
         * @return string
         */
