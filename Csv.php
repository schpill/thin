<?php
    ...
    class Csv extends \SplFileInfo implements \Iterator
    {
        ...
        protected function _validateDelimiter($delimiter)
        {
            if (strlen($delimiter) > 1) {
                throw new Exception("Delimiter must be a single character. \"$delimiter\" received");
            }
        ...
        protected function _validateEnclosure($enclosure)
        {
            if (strlen($enclosure) > 1) {
                throw new Exception("Enclosure must be a single character. \"$enclosure\" received");
            }
        }
