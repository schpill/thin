<?php
	...
	class Dispatcher
	{
		 ...
		 *
		 * @param  Eventable  $container
		 * @return void
		 */
		public function __construct(Eventable $container = null)
		{
		...
		{
			return Arrays::last($this->firing);
		}
		...
		protected function getWildcardListeners($eventName)
		{
			...
			foreach ($this->wildcards as $key => $listeners) {
				if ($this->strIs($key, $eventName)) $wildcards = array_merge($wildcards, $listeners);
			}
