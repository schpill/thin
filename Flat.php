<?php
    ...
    class Flat
    {
        public static function getAll($type)
        {
            ...
            $objects    = glob(STORAGE_PATH . DS . 'flat' . DS . $dir . DS . '*.' . Inflector::lower($type), GLOB_NOSORT);
            return $objects;
        }
        ...
        public static function add($type)
        {
            ...
            Utils::go(URLSITE . Inflector::lower($type) . '/list/' . Inflector::lower($type));
        }
        ...
        public static function store($type, $flat, $key = null)
        {
            ...
            $file       = STORAGE_PATH . DS . 'flat' . DS . $dir . DS . $key . '.' . Inflector::lower($type);
            File::delete($file);
        ...
        public static function makeKey($type)
        {
            ...
            $check  = STORAGE_PATH . DS . 'flat' . DS . $dir . DS . $key . '.' . Inflector::lower($type);
        ...
        private static function checkDir($type)
        {
            ...
            $dir     = STORAGE_PATH . DS . 'flat' . DS . $dir;
            if (!is_dir($dir)) {
                mkdir($dir, 0777);
            }
            return $dirName;
