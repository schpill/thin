<?php
    ...
    use Thin\Highchart\Option;
    use Thin\Highchart\Renderer;
    ...
    class Highchart implements \ArrayAccess
    {
        ...
        {
            return Renderer::render($this->_options);
        }
        ...
        {
            $this->_options[$offset] = new Option($value);
        }
        ...
        public function offsetGet($offset)
        {
            if (!isset($this->_options[$offset])) {
                $this->_options[$offset] = new Option();
            }
