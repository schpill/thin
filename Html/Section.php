...
class Section
{
	 ...
	 *		Section::start('header', '<title>Thin</title>');
	 * </code>
	 *
	...
	{
		if ($content === '') {
			ob_start() && array_push(static::$last, $section);
		} else {
	 ...
	 *		Section::inject('header', '<title>Thin</title>');
	 * </code>
	 *
	 * @param  string  $section
	...
	{
		return isAke(static::$sections, $section, '');
	}
