<?php
	...
	class Color
	{
		...
		* @return Image\Color
		*/
		public static function loadJpeg($imagePath)
		{
			return new self(imagecreatefromjpeg($imagePath));
		}
		...
		* @return Image\Color
		*/
		public static function loadPng($imagePath)
		{
			return new self(imagecreatefrompng($imagePath));
		}
		...
		* @return Image\Color
		*/
		public static function loadGif($imagePath)
		{
			return new self(imagecreatefromgif($imagePath));
		}
	}
