    ...
    abstract class Container implements \RecursiveIterator, \Countable
    {
        ...
        public function addPage($page)
        {
            ...
            if (is_array($page)) {
                ...
                throw new Exception('Invalid argument: $page must be an array');
            }
         ...
         *
         * @param  array|Container  $pages  pages to add
         * @return Container                    fluent interface,
         *                                                      returns self
         * @throws Exception                    if $pages is not
         *                                                      array or
         *                                                      Container
         */
        public function addPages($pages)
        {
            ...
            if (!is_array($pages)) {
                throw new Exception('Invalid argument: $pages must be an array, an instance of Container');
            }
         ...
         *
         * @return array  array of Page instances
         */
         ...
         *
         * @param  Page|int $page      page to remove, either a page
         ...
         *                           Default is false.
         * @return array             array containing only Page
         *                           instances
         */
