<?php
    namespace Thin\Navigation\Page;

    use Thin\Navigation\Page;
    use Thin\Controller\Front;
    use Thin\Exception;
    ...
    class Mvc extends Page
    {
         ...
         * @throws Exception  if invalid $action is given
         */
         ...
         * @return Mvc   fluent interface, returns self
         * @throws Exception  if invalid controller name is given
         */
         ...
         * @return Mvc   fluent interface, returns self
         * @throws Exception  if invalid module name is given
         */
         ...
         * @return Mvc   fluent interface, returns self
         * @throws Exception  if invalid $route is given
         */
