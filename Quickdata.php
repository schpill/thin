<?php
    ...
    class Quickdata extends Customize
    {
        private $ns;
        private $entity;
        private $db;
        ...
        public function __construct($entity, $ns = 'core')
        {
            ...
            $this->entity   = $entity;
            $this->db       = 'db_' . $entity;
            $this->lock     = Inflector::camelize('quick_db');
        }
        ...
        private function driver()
        {
            ...
            return count($drivers) ? Arrays::first($drivers) : Quickdb::instance($this->ns);
        }
        ...
        private static function structure($table, $fields)
        {
            ...
            if (is_null($t)) {
                $t = $dbt->create()->setName($table)->save();
            }
