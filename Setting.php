<?php
     ...
     */
    class Setting implements Countable, Iterator, ArrayAccess
    {
        /**
        ...
        /**
         * Deep clone of this instance to ensure that nested settings are also
         * cloned.
         *
         * @return void
         */
        ...
        {
            if (false !== $this->skipNextIteration) {
                $this->skipNextIteration = false;
                return;
            }
