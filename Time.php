<?php
    ...
    class Time extends DateTime
    {
        ...
        /**
         * A test Time instance to be returned when now instances are created
         *
         * @var Time
         */
        ...
        /**
         * Create a Time instance from a DateTime one
         *
         * @param DateTime $dt
         *
         * @return static
        ...
        /**
         * Create a Time instance from a string.  This is an alias for the
         * constructor that allows better fluent syntax as it allows you to do
         * Time::parse('Monday next week')->fn() rather than
         * (new Time('Monday next week'))->fn()
         *
         * @param string              $time
         * @param DateTimeZone|string $tz
         *
        ...
        /**
         * Get a Time instance for the current date and time
         *
         * @param DateTimeZone|string $tz
         *
         * @return static
        ...
        /**
         * Create a Time instance for the greatest supported date.
         *
         * @return Time
         */
        ...
        /**
         * Create a Time instance for the lowest supported date.
         *
         * @return Time
         */
        ...
        /**
         * Create a new Time instance from a specific date and time.
         *
        ...
        /**
         * Create a Time instance from just a date. The time portion is set to now.
         *
         * @param integer             $year
         * @param integer             $month
         * @param integer             $day
        ...
        /**
         * Create a Time instance from just a time. The date portion is set to today.
         *
         * @param integer             $hour
         * @param integer             $minute
         * @param integer             $second
        ...
        /**
         * Create a Time instance from a specific format
         *
         * @param string              $format
         * @param string              $time
         * @param DateTimeZone|string $tz
        ...
        /**
         * Create a Time instance from an UTC timestamp
         *
         * @param integer $timestamp
         *
         * @return static
         ...
         *   - A call to the static now() method, ex. Time::now()
         *   - When a null (or blank string) is passed to the constructor or parse(), ex. new Time(null)
         *   - When the string "now" is passed to the constructor or parse(), ex. new Time('now')
         *
        ...
        /**
         * Get the Time instance (real or mock) to be returned when a "now"
         * instance is created.
         *
        ...
        /**
         * Reset the format used to the default when type juggling a Time instance to a string
         *
         */
        ...
        /**
         * Set the default format used when type juggling a Time instance to a string
         *
         * @param string $format
         */
       ...
       */
         ...
         * @return string
         */
        public function diffForHumans(Time $other = null)
        {
            $isNow = $other === null;
        ...
        public function endOfDecade()
        {
            return $this->endOfYear()->year(
                $this->year - $this->year % self::YEARS_PER_DECADE + self::YEARS_PER_DECADE - 1
            );
        }
        ...
        {
            return $this->endOfYear()->year(
                $this->year - $this->year % self::YEARS_PER_CENTURY + self::YEARS_PER_CENTURY - 1
            );
        }
