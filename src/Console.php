<?php
    ...
    final class Console
    {
        ...
        public static function error($msg)
        {
            ...
            $out = self::colorize(
                str_pad(' ', $space), Console::FG_WHITE, Console::AT_BOLD, Console::BG_RED
            );

            $out .= PHP_EOL;

            $out .= self::colorize(
                '  ' . $msg . '  ', Console::FG_WHITE, Console::AT_BOLD, Console::BG_RED
            );
            $out .= PHP_EOL;
        ...
        {
            return self::colorize($msg, Console::FG_RED, Console::AT_BOLD) . PHP_EOL . PHP_EOL;
        }
         ...
         * @return string
         */
        public static function infoLine($msg, $lineBefore = true, $afterLinesCount = 2, $color = Console::FG_GREEN)
        {
            $out = '';
            if ($lineBefore) {
                $out .= PHP_EOL;
            ...
            $out .= self::colorize($msg, $color, Console::AT_BOLD);
        ...
        {
            return self::colorize($msg, Console::FG_BROWN) . PHP_EOL;
        }
        ...
        public static function commandLine(
            $cmd,
            $comment = '',
            $commentColor = Console::FG_BROWN,
            $cmdColor = Console::FG_GREEN
        )
        {
