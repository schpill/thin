    ...
    class Dropbox
    {
        ...
        private function buildQuery(array $parameters)
        {
            ...
            foreach ($parameters as $key => $value) {
                // sort by value
                if(Arrays::is($value)) $parameters[$key] = natsort($value);
            }
         ...
         * @return array
         */
        public function oAuthRequestToken($ret = false)
        {
            // make the call
            ...
            $this->setOAuthToken($return['oauth_token']);
            $this->setOAuthTokenSecret($return['oauth_token_secret']);

            // return
            return true === $ret ? $return : $this;
        }
