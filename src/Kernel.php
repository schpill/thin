<?php
    ...
    class Kernel
    {
        ...
        protected $lastDispatch = [];
        protected $instances = [];
        protected $callbacks = [];

        /**
         * Returns an instance of class itself === Singleton
         *
        ...
        public static function getInstance(array $config = [])
        {
            if (!is_object(static::$self)) {
                ...
                if (Arrays::is($config) && count($config) > 0) {
        ...
        {
            $instanceHash = sha1($className . serialize($params));
            ...
            if (0 === $paramCount) {
                ...
                $instance = new $className(Arrays::first($params));
            } elseif (2 === $paramCount) {
         ...
         *
         * @param string Event namespace (default is 'Thin')
         */
        public function events($ns = 'Thin')
        {
         ...
         */
        public function trace($msg = null, $data = [], $function = null, $file = null, $line = null, $internal = false)
        {
         ...
         */
        protected function traceInternal($msg = null, $data = [], $function = null, $file = null, $line = null)
        {
            // Don't incur the overhead if not in debug mode
            if (!static::$debug) {
                return false;
        ...
        public function plugin($plugin, array $pluginConfig = [], $init = true)
        {
            ...
            if (!class_exists($sPluginClass, (boolean) $init)) {
                if ($init) {
                    throw new \InvalidArgumentException("Unable to load plugin '" . $sPluginClass . "'. Remove from app configuration file or ensure plugin files exist in 'app' or 'Thin' load paths.");
                }
            ...
            return $this->factory($sPluginClass, [$this, $pluginConfig]);
        }
         ...
         */
        public function dispatch($module, $action = 'index', array $params = [])
        {
            if ($module instanceof \Thin\Controller) {
         ...
         * @return mixed String or object that has __toString method
         */
        public function dispatchRequest($module, $action = 'indexAction', array $params = [])
        {
         ...
         * @return string
         */
        public function url($params = [], $routeName = null, $queryParams = [], $qsAppend = false)
        {
        ...
        {
            return ucwords(str_replace('_', ' ', Inflector::lower($word)));
        }
