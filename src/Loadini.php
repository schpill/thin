<?php
    namespace Thin;
    class Loadini implements \Countable, \Iterator
    {
        /**
        ...
        /**
         * Loadini provides a property based interface to
         * an array. The data are read-only unless $allowModifications
         * is set to true on construction.
         *
         * Loadini also implements Countable and Iterator to
        ...
        public function __set($name, $value)
        {
            if ($this->_allowModifications) {
                ...
                throw new Exception('Loadini is read only');
            }
        }

        /**
         * Deep clone of this instance to ensure that nested Loadinis
         * are also cloned.
         *
         * @return void
         */
        ...
        /**
         * Merge another Loadini with this one. The items
         ...
         * @return Loadini
         */
        public function merge(Loadini $merge)
        {
            foreach($merge as $key => $item) {
                if(Arrays::exists($key, $this->_data)) {
                    if($item instanceof Loadini && $this->$key instanceof Loadini) {
                        $this->$key = $this->$key->merge(new Loadini($item->toArray(), !$this->readOnly()));
                    } else {
                        $this->$key = $item;
                    }
                } else {
                    if($item instanceof Loadini) {
                        $this->$key = new Loadini($item->toArray(), !$this->readOnly());
                    } else {
                        $this->$key = $item;
                    }
                }
         ...
         * after merge() has been used to merge multiple Loadini objects
        ...
        /**
         * Returns if this Loadini object is read only or not.
         *
         * @return boolean
         */
        ...
        /**
         * Set an extend for Loadini_Writer
         *
        ...
        protected function _assertValidExtend($extendingSection, $extendedSection)
        {
            ...
            while (Arrays::exists($extendedSectionCurrent, $this->_extends)) {
