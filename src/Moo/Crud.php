<?php
    ...
    class Crud
    {
        ...
        public function __construct(Database $model)
        {
            ...
            $fileConfig = APPLICATION_PATH . DS . 'models' . DS . 'CrudRaw' . DS . ucfirst(Inflector::camelize($model->db)) . DS . ucfirst(Inflector::camelize($model->table)) . '.php';
        ...
        public static function instance(Database $model)
        {
            ...
            $has    = Instance::has('BoxCrud', $key);

            if (true === $has) {
                return Instance::get('BoxCrud', $key);
            } else {
                return Instance::make('BoxCrud', $key, new self($model));
            }
        }
