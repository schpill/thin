<?php
	...
	final class Period
	{
	     ...
	     *
	     * @param bool $getAsSeconds If used and set to true, the method will return an int which
	     *                             represents the duration in seconds instead of a \DateInterval
	     *                             object.
	     *
	     * @return \DateInterval|int|double
	     */
	    public function getDuration($getAsSeconds = false)
	    {
	        if (true === $getAsSeconds) {
	     ...
	     * - a Period object
	     *
	     * @param \Thin\Period|\DateTime $index
	     *
	     * @return bool
	     */
	     ...
	     * - a Period object
	     *
	     * @param \Thin\Period|\DateTimeInterface|\DateTime $index
	     *
	     * @return bool
	     */
	     ...
	     *
	     * @param \Thin\Period $arg,... one or more Period objects
	     *
	     * @return \Thin\Period
	     */
	    public function merge()
	    {
	        ...
	        array_walk(
	        	$args, function (Period $period) use (&$res) {
