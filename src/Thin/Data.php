<?php
    ...
    class Data
    {
        ...
        protected static $_numberOfQueries      = 0;
        protected static $_totalDuration        = 0;
        ...
        public static function getObject($object, $type = null)
        {
            if (!is_string($object)) {
                ...
                $dir = static::checkDir($type);
                $object = STORAGE_PATH . DS . 'data' . DS . $dir . DS . $id . '.data';
                dieDump($object);
            }
        ...
        public static function add($type)
        {
            ...
            $infos      = array('id' => $key, 'date_create' => time()) + $_POST;
        ...
        public static function edit($type, $id)
        {
            ...
            $infos      = array('id' => $id, 'date_create' => $object->getDateCreate()) + $_POST;
            ...
            if (count($conditionsOr)) {
                foreach ($conditionsOr as $condition) {
                    foreach ($datas as $tmpObject) {
                        ...
                        $condition  = repl('NOT LIKE', 'NOTLIKE', $condition);
                        $condition  = repl('NOT IN', 'NOTSalles de réceptionIN', $condition);
