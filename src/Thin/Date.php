<?php
    ...
    class Date extends \DateTime
    {
        ...
        /**
         * Create a new FTV_Date instance.
         *
         * @param  string  $time
        ...
        /**
         * Make and return new FTV_Date instance.
         *
         * @param  string  $time
         * @param  string|DateTimeZone  $timezone
         * @return FTV_Date
        ...
        public function getDifferenceInMonths($compare = null)
        {
            ...
            list($years, $months) = explode(':', $difference->format('%y:%m'), 2);
        ...
        public function getDifferenceInSeconds($compare = null)
        {
            ...
            list($days, $hours, $minutes, $seconds) = explode(':', $difference->format('%a:%h:%i:%s'), 4);
        ...
        public function __call($method, $args)
        {
            ...
            if (substr($method, 0, 3) == 'set')  {
                return $this->setDateAttribute($attribute, $args[0]);
            }
        ...
        public static function getMidnight()
        {
            return mktime(0, 0, 0);
        }
