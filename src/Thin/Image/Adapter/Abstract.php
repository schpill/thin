<?php
    ...
    abstract class Abstract
    {
        ...
        public static function calculateSize($sourceWidth, $sourceHeight, $scale, $inflate, $maxWidth, $maxHeight, $minWidth = null, $minHeight = null)
        {
            if ($maxWidth > 0) {
        ...
        protected function _initThumb($sourceWidth, $sourceHeight, $scale, $inflate, $maxWidth, $maxHeight, $minWidth = null, $minHeight = null)
        {
