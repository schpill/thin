<?php
    ...
    class Rest
    {
        ...
        private function getHeaders()
        {
            ...
            foreach($keys as $val) {
                    $key = repl(' ', '-', ucwords(Inflector::lower(repl('_', ' ', substr($val, 5)))));
        ...
        {
            return (isset(static::$codes[$status])) ? static::$codes[$status] : static::$codes[500];
        }
        ...
        {
            return (in_array($format, static::$formats)) ? $format : static::DEFAULT_RESPONSE_FORMAT;
        }
        ...
        {
            return static::$contentTypes[$type];
        }
